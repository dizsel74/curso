...
<body>
<h2> INSERT 2/2 PAGINAS preparadas</h2>
<?php
	...
	$query="INSERT INTO datos_usuario(nombre, clave, Edad) VALUES (?,?,?)"; //Query 
	 //$query="INSERT INTO datos_usuario(nombre, clave, Edad) VALUES ('$nom','$clav',$anos )"; //Query 
	  ...
	  $ok=mysqli_stmt_bind_param($resultado_query,"ssi",$nom,$clav,$anos);  // 3er paso unes al stmt con el tipo de dato(string o numerico) y el dato buscado
